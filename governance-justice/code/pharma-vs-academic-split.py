#!/usr/bin/env python3
"""
Pharma vs Academic Split -- SAARC Clinical Trial Equity Analysis
Group: governance-justice | Paper #2
...
Run: python pharma-vs-academic-split.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'Pharma vs Academic Split'}")
