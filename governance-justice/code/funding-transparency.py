#!/usr/bin/env python3
"""
Funding Transparency -- SAARC Clinical Trial Equity Analysis
Group: governance-justice | Paper #20
...
Run: python funding-transparency.py
"""
