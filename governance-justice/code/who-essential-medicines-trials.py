#!/usr/bin/env python3
"""
WHO Essential Medicines Trials -- SAARC Clinical Trial Equity Analysis
Group: governance-justice | Paper #15
...
Run: python who-essential-medicines-trials.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'WHO Essential Medicines Trials'}")
