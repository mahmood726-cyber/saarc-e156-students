#!/usr/bin/env python3
"""
Paediatric Trial Ethics -- SAARC Clinical Trial Equity Analysis
...
Run: python paediatric-trial-ethics.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'Paediatric Trial Ethics'}")
    ...
    country_values = [512, 349, 143, 28, 7, 3, 0, 0]
