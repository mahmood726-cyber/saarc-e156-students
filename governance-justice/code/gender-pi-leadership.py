#!/usr/bin/env python3
"""
Gender in PI Leadership -- SAARC Clinical Trial Equity Analysis
Group: governance-justice | Paper #8
...
Run: python gender-pi-leadership.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'Gender in PI Leadership'}")
