#!/usr/bin/env python3
"""
Mental Health Desert -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #9

Condition: Depression OR Anxiety OR Schizophrenia OR Mental Health
...
Run: python mental-health-desert.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Depression OR Anxiety OR Schizophrenia OR Mental Health"
...
def main():
    ...
    country_values = [212, 200, 29, 13, 2, 2, 0, 0]
