#!/usr/bin/env python3
"""
Malnutrition & Stunting -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #15

Condition: Malnutrition OR Stunting OR Wasting
...
Run: python malnutrition-stunting.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Malnutrition OR Stunting OR Wasting"
...
def main():
    ...
    country_names = ["Bangladesh", "Pakistan", "India", "Nepal", "Afghanistan", "Sri Lanka", "Bhutan", "Maldives"]
    country_values = [79, 61, 49, 13, 3, 0, 0, 0]
