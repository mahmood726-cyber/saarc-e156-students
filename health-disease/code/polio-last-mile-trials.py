#!/usr/bin/env python3
"""
Polio Last-Mile Trials -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #7

Condition: Polio OR Poliomyelitis
...
Run: python polio-last-mile-trials.py
"""
...
SAARC_COUNTRIES = ["Pakistan", "Afghanistan"]
SAARC_POPULATIONS = {
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Polio OR Poliomyelitis"
    params["query.locn"] = "Pakistan OR Afghanistan"
    try:
...
def main():
    print("=" * 64)
    print(f"  {'Polio Last-Mile Trials'}")
    ...
    country_names = ["Pakistan", "Afghanistan"]
    country_values = [12, 0]
