#!/usr/bin/env python3
"""
Surgical Trial Scarcity -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #22

Condition: Surgery OR Surgical
...
Run: python surgical-trial-scarcity.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Surgery OR Surgical"
...
def main():
    print("=" * 64)
    print(f"  {'Surgical Trial Scarcity'}")
    ...
    country_values = [278, 250, 30, 7, 2, 0, 0, 0]
