#!/usr/bin/env python3
"""
Leishmaniasis (Kala-azar) -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #18

Condition: Leishmaniasis OR Kala-azar
...
Run: python leishmaniasis-kala-azar.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Leishmaniasis OR Kala-azar"
...
def main():
    print("=" * 64)
    print(f"  {'Leishmaniasis (Kala-azar)'}")
    ...
    country_names = ["India", "Bangladesh", "Pakistan", "Nepal", "Afghanistan", "Sri Lanka", "Bhutan", "Maldives"]
    country_values = [20, 11, 4, 2, 2, 0, 0, 0]
