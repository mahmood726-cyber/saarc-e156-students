#!/usr/bin/env python3
"""
Chronic Kidney Disease -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #13

Condition: Chronic Kidney Disease OR Nephrology
...
Run: python chronic-kidney-disease.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Chronic Kidney Disease OR Nephrology"
...
def main():
    print("=" * 64)
    print(f"  {'Chronic Kidney Disease'}")
    ...
    country_names = ["India", "Pakistan", "Bangladesh", "Sri Lanka", "Nepal", "Afghanistan", "Bhutan", "Maldives"]
    country_values = [76, 12, 3, 2, 2, 0, 0, 0]
