#!/usr/bin/env python3
"""
HIV Low-Prevalence Paradox -- SAARC Clinical Trial Equity Analysis
...
Run: python hiv-low-prevalence-paradox.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'HIV Low-Prevalence Paradox'}")
    ...
    country_values = [81, 6, 6, 1, 0, 0, 0, 0]
