#!/usr/bin/env python3
"""
Disease Burden Concordance Index -- SAARC Clinical Trial Equity Analysis
...
Run: python disease-burden-concordance-index.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'Disease Burden Concordance Index'}")
