#!/usr/bin/env python3
"""
Maternal Mortality Crisis -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #5

Condition: Maternal Health OR Preeclampsia OR Postpartum Hemorrhage
...
Run: python maternal-mortality-crisis.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Maternal Health OR Preeclampsia OR Postpartum Hemorrhage"
...
def main():
    print("=" * 64)
    print(f"  {'Maternal Mortality Crisis'}")
    ...
    country_names = ["Pakistan", "India", "Bangladesh", "Nepal", "Afghanistan", "Sri Lanka", "Bhutan", "Maldives"]
    country_values = [54, 38, 18, 11, 1, 0, 0, 0]
