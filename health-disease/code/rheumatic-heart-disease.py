#!/usr/bin/env python3
"""
Rheumatic Heart Disease -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #12
...
def main():
    ...
    country_names = ["Nepal", "India", "Pakistan", "Bangladesh", "Sri Lanka", "Afghanistan", "Bhutan", "Maldives"]
    country_values = [6, 3, 3, 0, 0, 0, 0, 0]
