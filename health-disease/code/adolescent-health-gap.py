#!/usr/bin/env python3
"""
Adolescent Health Gap -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #31

Condition: Adolescent Health OR Youth
...
Run: python adolescent-health-gap.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Adolescent Health OR Youth"
...
def main():
    ...
    country_names = ["India", "Pakistan", "Bangladesh", "Nepal", "Afghanistan", "Bhutan", "Sri Lanka", "Maldives"]
    country_values = [132, 48, 17, 9, 1, 1, 0, 0]
