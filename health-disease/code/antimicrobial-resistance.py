#!/usr/bin/env python3
"""
Antimicrobial Resistance -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #16

Condition: Antimicrobial Resistance OR Antibiotic Resistance
...
Run: python antimicrobial-resistance.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Antimicrobial Resistance OR Antibiotic Resistance"
...
def main():
    print("=" * 64)
    print(f"  {'Antimicrobial Resistance'}")
    ...
    country_values = [5, 2, 2, 1, 0, 0, 0, 0]
