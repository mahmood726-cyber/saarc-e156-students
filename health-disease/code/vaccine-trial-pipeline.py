#!/usr/bin/env python3
"""
Vaccine Trial Pipeline -- SAARC Clinical Trial Equity Analysis
...
Run: python vaccine-trial-pipeline.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'Vaccine Trial Pipeline'}")
    ...
    country_names = ["India", "Bangladesh", "Pakistan", "Nepal", "Sri Lanka", "Afghanistan", "Bhutan", "Maldives"]
    country_values = [121, 87, 30, 11, 4, 0, 0, 0]
