#!/usr/bin/env python3
"""
TB Trial Landscape -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #3
...
Run: python tb-trial-landscape.py
"""
...
def main():
    ...
    country_values = [62, 24, 6, 3, 0, 0, 0, 0]
