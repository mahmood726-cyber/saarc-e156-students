#!/usr/bin/env python3
"""
Palliative Care Evidence -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #30

Condition: Palliative Care OR Hospice
...
Run: python palliative-care-evidence.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Palliative Care OR Hospice"
...
def main():
    print("=" * 64)
    print(f"  {'Palliative Care Evidence'}")
    ...
    country_values = [14, 3, 1, 1, 0, 0, 0, 0]
