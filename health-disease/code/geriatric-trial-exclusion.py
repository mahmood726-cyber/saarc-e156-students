#!/usr/bin/env python3
"""
Geriatric Trial Exclusion -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #32

Condition: Elderly OR Geriatric
...
Run: python geriatric-trial-exclusion.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Elderly OR Geriatric"
...
def main():
    print("=" * 64)
    print(f"  {'Geriatric Trial Exclusion'}")
    ...
    country_names = ["Pakistan", "India", "Bangladesh", "Nepal", "Sri Lanka", "Afghanistan", "Bhutan", "Maldives"]
    country_values = [100, 90, 16, 4, 2, 0, 0, 0]
