#!/usr/bin/env python3
"""
Hepatitis B/C Hotspot -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #4

Condition: Hepatitis B OR Hepatitis C
...
Run: python hepatitis-bc-hotspot.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Hepatitis B OR Hepatitis C"
...
def main():
    ...
    country_names = ["India", "Pakistan", "Bangladesh", "Afghanistan", "Sri Lanka", "Nepal", "Bhutan", "Maldives"]
    country_values = [59, 17, 7, 1, 0, 0, 0, 0]
