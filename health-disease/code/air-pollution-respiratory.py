#!/usr/bin/env python3
"""
Air Pollution & Respiratory -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #19

Condition: Air Pollution OR COPD OR Asthma
...
Run: python air-pollution-respiratory.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Air Pollution OR COPD OR Asthma"
...
def main():
    print("=" * 64)
    print(f"  {'Air Pollution & Respiratory'}")
    ...
    country_values = [130, 114, 10, 3, 1, 0, 0, 0]
