#!/usr/bin/env python3
"""
Eye Health & Blindness -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #23

Condition: Cataract OR Glaucoma OR Blindness OR Ophthalmology
...
Run: python eye-health-blindness.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Cataract OR Glaucoma OR Blindness OR Ophthalmology"
...
def main():
    ...
    country_values = [57, 7, 3, 1, 0, 0, 0, 0]
