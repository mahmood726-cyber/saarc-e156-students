#!/usr/bin/env python3
"""
Burn & Trauma Trials -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #34

Condition: Burns OR Trauma OR Emergency Medicine
...
Run: python burn-trauma-trials.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Burns OR Trauma OR Emergency Medicine"
...
def main():
    ...
    country_names = ["Pakistan", "India", "Nepal", "Bangladesh", "Afghanistan", "Sri Lanka", "Bhutan", "Maldives"]
    country_values = [339, 146, 18, 9, 5, 2, 1, 0]
