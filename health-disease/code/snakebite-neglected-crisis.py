#!/usr/bin/env python3
"""
Snakebite Neglected Crisis -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #17

Condition: Snakebite OR Snake Envenomation
...
Run: python snakebite-neglected-crisis.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Snakebite OR Snake Envenomation"
...
def main():
    print("=" * 64)
    print(f"  {'Snakebite Neglected Crisis'}")
    ...
    country_names = ["India", "Bangladesh", "Sri Lanka", "Nepal", "Pakistan", "Afghanistan", "Bhutan", "Maldives"]
    country_values = [4, 1, 1, 1, 0, 0, 0, 0]
