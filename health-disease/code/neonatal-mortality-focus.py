#!/usr/bin/env python3
"""
Neonatal Mortality Focus -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #14
...
Run: python neonatal-mortality-focus.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'Neonatal Mortality Focus'}")
    ...
    country_values = [254, 196, 44, 20, 4, 1, 0, 0]
