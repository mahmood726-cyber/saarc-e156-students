#!/usr/bin/env python3
"""
Occupational Health -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #33

Condition: Occupational Health OR Occupational Disease
...
Run: python occupational-health.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Occupational Health OR Occupational Disease"
...
def main():
    ...
    country_values = [5, 3, 3, 2, 0, 0, 0, 0]
