#!/usr/bin/env python3
"""
Oral Health Neglect -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #24

Condition: Oral Cancer OR Dental OR Oral Health
...
Run: python oral-health-neglect.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Oral Cancer OR Dental OR Oral Health"
...
def main():
    ...
    country_values = [141, 86, 5, 3, 2, 0, 0, 0]
