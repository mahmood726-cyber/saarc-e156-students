#!/usr/bin/env python3
"""
Rare Disease Orphan Gap -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #27

Condition: Rare Disease OR Orphan Drug
...
Run: python rare-disease-orphan-gap.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Rare Disease OR Orphan Drug"
...
def main():
    print("=" * 64)
    print(f"  {'Rare Disease Orphan Gap'}")
    ...
    country_values = [4, 0, 0, 0, 0, 0, 0, 0]
