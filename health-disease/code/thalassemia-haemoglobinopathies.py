#!/usr/bin/env python3
"""
Thalassemia & Haemoglobinopathies -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #8

Condition: Thalassemia OR Hemoglobinopathy
...
Run: python thalassemia-haemoglobinopathies.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Thalassemia OR Hemoglobinopathy"
...
def main():
    print("=" * 64)
    print(f"  {'Thalassemia & Haemoglobinopathies'}")
    ...
    country_values = [15, 14, 2, 1, 0, 0, 0, 0]
