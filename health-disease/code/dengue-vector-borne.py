#!/usr/bin/env python3
"""
Dengue & Vector-Borne -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #6

Condition: Dengue OR Chikungunya OR Malaria
...
Run: python dengue-vector-borne.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Dengue OR Chikungunya OR Malaria"
...
def main():
    ...
    country_names = ["India", "Bangladesh", "Pakistan", "Afghanistan", "Sri Lanka", "Nepal", "Bhutan", "Maldives"]
    country_values = [23, 17, 9, 7, 3, 3, 0, 0]
