#!/usr/bin/env python3
"""
Hypertension Awareness Gap -- SAARC Clinical Trial Equity Analysis
Group: health-disease | Paper #20
...
Run: python hypertension-awareness-gap.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'Hypertension Awareness Gap'}")
    ...
    country_values = [134, 80, 21, 13, 5, 0, 0, 0]
