#!/usr/bin/env python3
"""
Conflict-Stability Trial Gradient -- SAARC Clinical Trial Equity Analysis
Group: geographic-equity | Paper #26

Condition: all interventional
Countries: Afghanistan, Pakistan, Sri Lanka
...
Run: python conflict-stability-trial-gradient.py
"""
...
SAARC_COUNTRIES = ["Afghanistan", "Pakistan", "Sri Lanka"]
SAARC_POPULATIONS = {
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.locn"] = "Afghanistan OR Pakistan OR Sri Lanka"
    try:
...
def main():
    print("=" * 64)
    print(f"  {'Conflict-Stability Trial Gradient'}")
    ...
    country_names = ["Pakistan", "Sri Lanka", "Afghanistan"]
    country_values = [4669, 75, 22]
