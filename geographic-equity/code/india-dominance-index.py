#!/usr/bin/env python3
"""
India Dominance Index -- SAARC Clinical Trial Equity Analysis
Group: geographic-equity | Paper #2
...
Run: python india-dominance-index.py
"""
