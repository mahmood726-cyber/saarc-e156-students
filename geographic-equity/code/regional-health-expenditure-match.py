#!/usr/bin/env python3
"""
Regional Health Expenditure Match -- SAARC Clinical Trial Equity Analysis
...
Run: python regional-health-expenditure-match.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'Regional Health Expenditure Match'}")
