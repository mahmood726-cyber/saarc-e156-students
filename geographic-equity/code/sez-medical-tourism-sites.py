#!/usr/bin/env python3
"""
SEZ & Medical Tourism Sites -- SAARC Clinical Trial Equity Analysis
...
Run: python sez-medical-tourism-sites.py
"""
...
SAARC_COUNTRIES = ["India", "Sri Lanka"]
SAARC_POPULATIONS = {
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.locn"] = "India OR Sri Lanka"
    try:
...
def main():
    print("=" * 64)
    print(f"  {'SEZ & Medical Tourism Sites'}")
    ...
    country_names = ["India", "Sri Lanka"]
    country_values = [5398, 75]
