#!/usr/bin/env python3
"""
Landlocked Penalty (Nepal/Bhutan) -- SAARC Clinical Trial Equity Analysis
Group: geographic-equity | Paper #23

Condition: all interventional
Countries: Nepal, Bhutan, Afghanistan
...
Run: python landlocked-penalty-nepal-bhutan.py
"""
...
SAARC_COUNTRIES = ["Nepal", "Bhutan", "Afghanistan"]
SAARC_POPULATIONS = {
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.locn"] = "Nepal OR Bhutan OR Afghanistan"
    try:
...
def main():
    print("=" * 64)
    print(f"  {'Landlocked Penalty (Nepal/Bhutan)'}")
    ...
    country_names = ["Nepal", "Afghanistan", "Bhutan"]
    country_values = [294, 22, 6]
