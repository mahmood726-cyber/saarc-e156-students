#!/usr/bin/env python3
"""
Pakistan Per-Capita Deficit -- SAARC Clinical Trial Equity Analysis
Group: geographic-equity | Paper #3
...
Run: python pakistan-per-capita-deficit.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'Pakistan Per-Capita Deficit'}")
