#!/usr/bin/env python3
"""
Delta & Floodplain Populations -- SAARC Clinical Trial Equity Analysis
...
Run: python delta-floodplain-populations.py
"""
...
SAARC_COUNTRIES = ["Bangladesh", "India"]
SAARC_POPULATIONS = {
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.locn"] = "Bangladesh OR India"
    try:
...
def main():
    print("=" * 64)
    print(f"  {'Delta & Floodplain Populations'}")
    ...
    country_names = ["India", "Bangladesh"]
    country_values = [5398, 652]
