#!/usr/bin/env python3
"""
Spatial Gini Coefficient -- SAARC Clinical Trial Equity Analysis
Group: geographic-equity | Paper #13
...
Run: python spatial-gini-coefficient.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'Spatial Gini Coefficient'}")
