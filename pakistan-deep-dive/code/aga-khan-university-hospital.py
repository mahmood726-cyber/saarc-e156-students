#!/usr/bin/env python3
"""
Aga Khan University Hospital -- SAARC Clinical Trial Equity Analysis
Group: pakistan-deep-dive | Paper #11
...
Run: python aga-khan-university-hospital.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'Aga Khan University Hospital'}")
