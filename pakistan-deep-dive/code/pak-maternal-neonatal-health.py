#!/usr/bin/env python3
"""
Maternal & Neonatal Health -- SAARC Clinical Trial Equity Analysis
Group: pakistan-deep-dive | Paper #27

Condition: Maternal Health OR Neonatal
Countries: Pakistan
...
Run: python pak-maternal-neonatal-health.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Maternal Health OR Neonatal"
...
def main():
    print("=" * 64)
    print(f"  {'Maternal & Neonatal Health'}")
