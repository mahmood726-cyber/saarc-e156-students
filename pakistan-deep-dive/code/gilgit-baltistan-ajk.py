#!/usr/bin/env python3
"""
Gilgit-Baltistan & AJK -- SAARC Clinical Trial Equity Analysis
Group: pakistan-deep-dive | Paper #6
...
Run: python gilgit-baltistan-ajk.py
"""
