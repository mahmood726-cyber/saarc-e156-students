#!/usr/bin/env python3
"""
HEC Research Funding -- SAARC Clinical Trial Equity Analysis
Group: pakistan-deep-dive | Paper #38
...
Run: python pak-hec-research-funding.py
"""
