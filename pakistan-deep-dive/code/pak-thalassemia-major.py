#!/usr/bin/env python3
"""
Thalassemia Major -- SAARC Clinical Trial Equity Analysis
Group: pakistan-deep-dive | Paper #25
...
Run: python pak-thalassemia-major.py
"""
