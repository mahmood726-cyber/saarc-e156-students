#!/usr/bin/env python3
"""
Mental Health Chasm -- SAARC Clinical Trial Equity Analysis
Group: pakistan-deep-dive | Paper #28

Condition: Depression OR Mental Health
Countries: Pakistan
...
Run: python pak-mental-health-chasm.py
"""
...
def fetch_trials(condition=None, location=None):
    ...
    params["query.cond"] = "Depression OR Mental Health"
