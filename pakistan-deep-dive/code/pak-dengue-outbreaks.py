#!/usr/bin/env python3
"""
Dengue Outbreaks -- SAARC Clinical Trial Equity Analysis
Group: pakistan-deep-dive | Paper #26
...
Run: python pak-dengue-outbreaks.py
"""
