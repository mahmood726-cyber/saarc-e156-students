#!/usr/bin/env python3
"""
Oral Cancer & Naswar/Gutka -- SAARC Clinical Trial Equity Analysis
Group: pakistan-deep-dive | Paper #30
...
Run: python pak-oral-cancer-naswar-gutka.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'Oral Cancer & Naswar/Gutka'}")
