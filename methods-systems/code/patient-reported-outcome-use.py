#!/usr/bin/env python3
"""
Patient-Reported Outcome Use -- SAARC Clinical Trial Equity Analysis
Group: methods-systems | Paper #18
...
Run: python patient-reported-outcome-use.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'Patient-Reported Outcome Use'}")
