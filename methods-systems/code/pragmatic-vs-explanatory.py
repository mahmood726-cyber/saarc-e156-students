#!/usr/bin/env python3
"""
Pragmatic vs Explanatory -- SAARC Clinical Trial Equity Analysis
Group: methods-systems | Paper #8
...
Run: python pragmatic-vs-explanatory.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'Pragmatic vs Explanatory'}")
