#!/usr/bin/env python3
"""
Non-Inferiority Trial Usage -- SAARC Clinical Trial Equity Analysis
Group: methods-systems | Paper #14
...
Run: python non-inferiority-trial-usage.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'Non-Inferiority Trial Usage'}")
