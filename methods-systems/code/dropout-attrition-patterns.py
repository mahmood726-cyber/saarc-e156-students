#!/usr/bin/env python3
"""
Dropout & Attrition Patterns -- SAARC Clinical Trial Equity Analysis
Group: methods-systems | Paper #12
...
Run: python dropout-attrition-patterns.py
"""
...
def main():
    print("=" * 64)
    print(f"  {'Dropout & Attrition Patterns'}")
